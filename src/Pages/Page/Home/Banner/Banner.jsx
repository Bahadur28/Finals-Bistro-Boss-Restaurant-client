            ...
            <div id="slide1" className="carousel-item relative w-full">
                ...
                <div className="absolute rounded-xl flex items-center h-full left-0 top-0 bg-gradient-to-r from-[#151515] to-[rgba(21, 21, 21, 0)]">
                    <div className='text-white space-y-7 pl-12 w-1/2'>
                        ...
                        <div>
                            <button className="btn btn-primary mr-5 bg-blue-500 p-3">Discover More</button>
                            <button className="btn btn-secondary bg-pink-500 p-3">Latest Project</button>
                        </div>
                    </div>
                </div>
            ...
            <div id="slide4" className="carousel-item relative w-full">
                ...
                <div className="absolute rounded-xl flex items-center h-full left-0 top-0 bg-gradient-to-r from-[#151515] to-[rgba(21, 21, 21, 0)]">
                    <div className='text-white space-y-7 pl-12 w-1/2'>
                        ...
                        <p>There are many variations of passages available, but the majority have suffered alteration in some form</p>
                        <div>
                            <button className="btn btn-primary bg-blue-500 mr-5 p-3">Discover More</button>
                            <button className="btn btn-secondary bg-pink-500 p-3">Latest Project</button>
                        </div>
                    </div>
                </div>
